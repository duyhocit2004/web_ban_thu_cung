            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    <td><?=$key + 1?></td>
                    <td><?=$as['ten_san_pham']?></td>
                    <td><?=$as['gia_san_pham']?></td>
                    <td><?=$as['gia_khuyen_mai']?></td>
                    <td><?=$as['hinh_anh']?></td>
                    <td><?=$as['so_luong']?></td>
                    <td><?=$as['luot_xem']?></td>
                    <td><?=$as['ngay_nhap']?></td>
                    <td><?=$as['mo_ta']?></td>
                    <td><?=$as['danh_muc_id']?></td>
                    <td>
                      <a href="?act=form-them-sanpham" class="btn btn-primary">sửa</a>
